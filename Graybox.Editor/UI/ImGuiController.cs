...
void main()
{
	...
	public void Update( GameWindow wnd, float deltaSeconds )
	{
		...
		if ( wnd != null ) UpdateImGuiInput( wnd );
	...
	public void ProcessKeyDown( KeyboardKeyEventArgs e )
	{
	...
	public void ProcessKeyUp( KeyboardKeyEventArgs e )
	{
		var key = TranslateKey( e.Key );
		if ( key == ImGuiKey.None ) return;
	...
	private void UpdateImGuiInput( GameWindow wnd )
	{
		...
		{
			io.MousePos = new SVector2( point.X, point.Y );
		}
	...
	public static ImGuiKey TranslateKey( Keys key )
	{
		...
		switch ( key )
		{
			...
			case Keys.LeftShift: return ImGuiKey.ModShift;
