		...
		Definitions = new List<HotkeyDefinition>
						   {
								...
								new HotkeyDefinition("Center Focused View on Selection", "Center the focused viewport on the current selection", HotkeysMediator.CenterFocusedViewOnSelection, "F"),
